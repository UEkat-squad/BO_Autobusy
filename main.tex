...
% *************** Front matter ***************
\input{front.tex} % Tutaj znajduje się strona tytułowa, spis treści, oświadczenia itd.

% *************** Treść rozdziałów *******-> 80-130 tys znakow

% \chapter*{Wstęp}
\input{chapters/wstep}
\input{chapters/wybor_autobusu.tex}
\input{chapters/analiza_wrazliwosci.tex}
\input{chapters/optymalizacja_rozkladu.tex}
