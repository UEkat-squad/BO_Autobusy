...
Dla kryteriów będących stymulantami (K1, K2, K3, K4), w których wyższa wartość jest pożądana, zastosowano formułę:
\begin{equation}
r_{ij} = \frac{x_{ij}}{\max_i x_{ij}}
\end{equation}

Dla kryterium będącego destymulantą (K5), gdzie niższa wartość jest preferowana, zastosowano odwróconą formułę proporcjonalności:
\begin{equation}
