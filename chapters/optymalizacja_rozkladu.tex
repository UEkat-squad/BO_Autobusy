...
\begin{itemize}
    \item \textbf{Struktura sieci:} Dynamiczne dodawanie, usuwanie lub zamiana linii w celu zbliżenia liczby tras do wartości \texttt{CEL\_LINII}.
...
\begin{itemize}
    \item \textbf{Tryb elitarny:} Wyłączenie selekcji elitarnej przy jednoczesnym zwiększeniu liczebności populacji, co sprzyja szerokiej eksploracji przestrzeni rozwiązań.
    \item \textbf{Tryb mutacji:} Znaczne podniesienie prawdopodobieństwa mutacji, wymuszające radykalne zmiany w strukturze genotypów.
    \item \textbf{Hipermutacja:} W procesie krzyżowania zastosowano pętlę wielokrotnej mutacji, która pozwala na gwałtowne "wypchnięcie" osobnika z obszaru suboptymalnego.
\end{itemize}
...
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_0.png}{Linia 1}{fig:Linia 1}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_1.png}{Linia 2}{fig:Linia 2}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_2.png}{Linia 3}{fig:Linia 3}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_3.png}{Linia 4}{fig:Linia 4}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_4.png}{Linia 5}{fig:Linia 5}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_5.png}{Linia 6}{fig:Linia 6}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_6.png}{Linia 7}{fig:Linia 7}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_7.png}{Linia 8}{fig:Linia 8}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_8.png}{Linia 9}{fig:Linia 9}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_9.png}{Linia 10}{fig:Linia 10}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_10.png}{Linia 11}{fig:Linia 11}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_11.png}{Linia 12}{fig:Linia 12}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_12.png}{Linia 13}{fig:Linia 13}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_13.png}{Linia 14}{fig:Linia 14}
\MyFigure[0.7\textwidth]{images/wizualizacja/linia_14.png}{Linia 15}{fig:Linia 15}

\MyFigure[0.7\textwidth]{images/wizualizacja/test.png}{Wszystkie linie}{fig:Wszystkie linie}
